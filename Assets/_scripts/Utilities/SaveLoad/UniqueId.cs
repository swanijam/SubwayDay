...
// 
// The identifier is serialised ensuring it will remain the same when the level is 
// reloaded
//
...
public class UniqueId : MonoBehaviour
{
    ...
    // Global lookup of IDs to Components - we can ensure at edit time that no two 
